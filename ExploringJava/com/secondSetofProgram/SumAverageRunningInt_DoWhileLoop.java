...
//in while loop condition will apply first,the loop will  execute the body/task as long as the the condition is true.
//if the condition is false the loop wont be execute the task/body.
